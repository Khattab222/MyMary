...
const HomeOrder = () => {
  return (
    ...
    {/* start right */}
       <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 flex-grow  justify-between items-center ">

        <div className="flex justify-start items-center gap-3 py-3 px-6 ">
